...
const getProfile = (params) =>
  new Promise((resolve, reject) => {
    if (params.language || params.accept_language) {
      params.headers = {
         'Content-Language': params.language ? params.language : params.accept_language,
         'Accept-Language': params.language ? params.language : params.accept_language
      };
    }
